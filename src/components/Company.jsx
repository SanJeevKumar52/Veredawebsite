  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center h-[164px] w-[1272px] text-center p-10">
        <h2
          className="text-4xl mb-4 font-bold leading-tight"
          style={{
        ...
        <p className="text-center max-w-[850px] h-[86px] text-[#42526B] text-[20px] ">
          ...
          coding. Build your next <br></br> consultancy website within a few
          minutes. You have a business to run. Stop <br></br> worrying about
          cross-browser bugs, designing new pages.
        </p>
      </div>

      <div className="h-[54.53px] w-[1272px] flex justify-around items-center justify-center">
        <div className="h-[54.3px]">
          <img src={bhaskar} alt="" />
        </div>
        <div>
