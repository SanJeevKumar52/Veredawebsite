...
const Hero = () => {
  return (
    <>
      <div className="text-white h-[818px]  bg-[#161C2D]">
        ...
        <div className="content-area w-[1228px] h-[514.7px]  ml-[206px] mt-[54px] flex justify-between items-center">
          <div className="w-[600px] h-[481px] flex-col justify-between ">
            <p
              class="text-gradient-to-r from-[#53ade4]; to-[#277ba8]"
              style={{
      ...
      <div className="h-[184px] font-[16px] font-bold text-[#061C3D] flex justify-around items-center pl-[50px] pr-[50px]">
        <div className=" flex flex-col justify-center items-center text-center">
          <div className=" text-[40px]">100+</div>
        ...
        <div className="flex flex-col justify-center items-center text-center">
          <div className="text-[40px]">$2M+</div>
